...
def iter_mask_refinement(
    ...
    with th.no_grad():
        ...
        mask_all_val = th.load(os.path.join("./model_save", experiment_name_masked_autoencoder+'_mask_save.pt'))
        loss_all_val = th.load(os.path.join("./model_save", experiment_name_masked_autoencoder+'_loss_save.pt'))
